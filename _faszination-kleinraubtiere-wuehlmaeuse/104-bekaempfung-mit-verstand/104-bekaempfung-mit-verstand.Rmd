...
Diese "Ökosystemleistung" erfordert von den Bewirtschaftern einzig eine vernünftige, ökologische Anordnung und Ausstattung ihrer Bewirtschaftungsflächen. Gleichzeitig muss unbedingt auf die Bekämpfung der Wühlmäuse mittels Giftködern verzichtet werden. 
Die Vergasung (z.B. mittels "Mauki") sollte ebenfalls sehr zurückhaltend angewendet werden, da sich Wiesel oft in den Gängen aufhalten, ja teilweise sogar dort vermehren. 
In die mechanischen Fallen geraten die Wiesel jedoch recht selten - Zugleich ist dies die verlässlichste Methode, um den Wühlmausbestand sehr niedrig zu halten.    
